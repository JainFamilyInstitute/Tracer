...
#                            Set Constants                                #
###########################################################################
N_SIM = 1e4                     # number of simulated individuals (per equivalence class)
END_AGE = 100                   # last possible consumption age
RETIRE_AGE = 65                 # retirement age
N_W = 501                       # number of values in wealth grid
LOWER_BOUND_W = 1               # lower bound of wealth
UPPER_BOUND_W = 15000000        # upper bound of wealth
N_C = 1501                      # number of values in consumption grid
LOWER_BOUND_C = 0               # lowest possible consumption value
R = 0.02                        # risk-free rate
DELTA = 0.99                    # discount factor
MU = 0                          # expectation of income shocks
INIT_WEALTH = 0                 # initial wealth value
...
# file names
coeff_fn = 'age_coefficients_and_var.xlsx'
...
ce_fn = 'ce.xlsx'
income_output_fn = 'base_income_'

# age at which each education level starts consuming
start_ages = {
    2: 18,
    3: 20,
    4: 22
